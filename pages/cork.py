...
def get_last_arome_run():
    ...
    runs = [3, 9, 15, 21]
    url ='https://www.meteociel.fr/modeles/pe-arome_table.php?x=0&y=0&lat=51.81&lon=-8.481&mode=8&sort=0'
...
def get_wind_gust_data(valid_run):
    ...
    url ='https://www.meteociel.fr/modeles/pe-arome_table.php?x=0&y=0&lat=51.81&lon=-8.481&mode=13&sort=0'
    url_run = f'{url}&run={valid_run}'
...
def get_pressure_data(valid_run):
    ...
    url ='https://www.meteociel.fr/modeles/pe-arome_table.php?x=0&y=0&lat=51.81&lon=-8.481&mode=1&sort=0'
    url_run = f'{url}&run={valid_run}'
...
def get_mucape_data(valid_run):
    ...
    url ='https://www.meteociel.fr/modeles/pe-arome_table.php?x=0&y=0&lat=51.81&lon=-8.481&mode=0&sort=0'
    url_run = f'{url}&run={valid_run}'
...
def get_prec_data(valid_run):
    ...
    url ='https://www.meteociel.fr/modeles/pe-arome_table.php?x=0&y=0&lat=51.81&lon=-8.481&mode=10&sort=0'
    url_run = f'{url}&run={valid_run}'
...
#
st.pyplot(plot_sun_elevation(51.88565192364632, -8.487610359300506, 'Europe/London'))
